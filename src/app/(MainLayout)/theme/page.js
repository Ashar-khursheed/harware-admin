...
import { NEXT_PUBLIC_STORAGE_URL } from "@/Utils/Constants";
            ...
            {data?.map((theme, i) => (
              <div key={i}>
                <div className={`theme-card ${activeTheme == theme.id ? "active" : ""}`}>
                  ...
                  >
                    <a href={"#Javascript"}>
                      <Image src={`${NEXT_PUBLIC_STORAGE_URL}/${theme.image}`} className="img-fluid bg-img bg_size_content" alt={theme?.name} height={1500} width={1500} />
                    </a>
